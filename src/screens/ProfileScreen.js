...
import { profileinput } from "../Data/DummyJson";
...
const ProfileScreen = () => {
  ...
  const [profileUpdateApi] = usePatient_profile_updateMutation();
  ...
  useEffect(() => {
    ...
    //     phoneNumber: "6356895956",
    //     address: "109, Sivan Kovil Sctreet",
    //     dateofbirth: "2001-01-22",
    //     Maritalstatus: "Single",
    //     gender: "Female",
    //     preconditions: "600067",
    //     allergies: "NA",
    //     bloodgroup: "A+ve",
    //     emergencynumber: "8956896585",
    //     emergencyname: "Murugan",
    //   });
    //   setLoad(false);
    // }, 2000);
  }, load);
              ...
              <>
                {item?.type === "select" ? (
                  <div className="w-sm-30 wi-100  pro position-relative">
                    ...
                    <select
                      disabled={item?.formFeald == "gender" || !editToggle}
                      ...
                      className={`${
                        ...
                        item?.formFeald == "gender" && "opacity-50 "
                      } w-100 py-md-2 custom-select py-2 px-md-2 px-2 border-0 bg-light rounded-2 f1  fs-xxl-16 fs-xl-15 fs-lg-15 fs-md-14 fs-sm-14 fs-xs-13 `}
                    >
