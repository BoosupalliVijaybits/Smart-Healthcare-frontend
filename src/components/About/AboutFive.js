...
const AboutFive = () => {
  return (
    <div className="d-flex ac-jc p-1 mt-2 mt-md-3 px-md-5 flex-column">
      ...
      <div className="steps-cont d-flex ac-jb w-100 flex-column flex-md-row mt-5 gap-5 gap-md-0">
        ...
        <div className="steps d-flex ac-jc flex-column">
          ...
          <div>
            ...
            <p className="mb-0 w-90 gray_text f2 fs-xxl-15 fs-xl-14 fs-lg-13 fs-sm-12 fs-xs-11 text-center">
